...
var projets = __webpack_require__(/*! ./projets/projets.json */ "./projets/projets.json");
...
function bootstrap() {
  ...
  _scripts_timebackground__WEBPACK_IMPORTED_MODULE_0__["animateTime"]();
}
...
function countdown(date, element) {
  ...
  document.querySelector(element).innerHTML = days + " jours, " + hours + " heures, " + minutes + " minutes et " + seconds + " secondes";
}

function startCommandLineMode(element) {
  var terminal = document.querySelector(element);
  terminal.insertAdjacentHTML("beforeend", "<span>Bienvenue dans la console Arnaux & Co !</span><br><span>Pour commencer, tapez 'help' ou '?'</span>");
...
function askForCommand(element) {
  ...
  terminal.insertAdjacentHTML("beforeend", "<br><div class='flex-input'><div>[root@arnodubo.is ~]#</div></div>");
...
/*!***********************************!*\
  !*** ./scripts/timebackground.js ***!
  \***********************************/
/*! exports provided: animateTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animateTime", function() { return animateTime; });
