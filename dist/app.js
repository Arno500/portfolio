...
/*!***************************!*\
  !*** ./scripts/events.js ***!
  \***************************/
/*! exports provided: addChooserListener, startMode, projectClickHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _typesbuilder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./typesbuilder */ "./scripts/typesbuilder.js");
...
function projectClickModal(event) {
  ...
  var content = _typesbuilder__WEBPACK_IMPORTED_MODULE_4__["build"](event.currentTarget.getAttribute("data-type"), event.currentTarget);
...
function commandInterpreter(command) {
  ...
  var cleanCommandHistory = commandHistory;
  localforage__WEBPACK_IMPORTED_MODULE_1__["setItem"]("commandHistory", cleanCommandHistory);
...
function rmCommand(args) {
  if (args && args[0] === "--i-know-what-i-am-doing-right-now-on-a-website-that-is-not-mine") {
    return {
      output: "Ah là là, vous faites vraiment tout ce qu'on vous dit"
    };
  } else {
    return {
      output: "C'est toujours une mauvaise idée. Si vous voulez être sûr, tapez --i-know-what-i-am-doing-right-now-on-a-website-that-is-not-mine"
    };
  }
}
...
function mailCommand(args) {
  ...
  return {
    output: "Vous avez plus qu'à m'envoyer un mail @ <a href=\"mailto:contact@arnodubo.is?subject=J'ai%20quelques%20travaux%20pour%20vous\">contact@arnodubo.is</a>"
  };
}
